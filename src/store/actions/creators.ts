...
export const removeSeedling = (seedling: Seedling) => createAction(ActionTypes.REMOVE_SEEDLING, seedling);
...
export const removeSeed = (seed: Seed) => createAction(ActionTypes.REMOVE_SEED, seed);
